          ...
          <motion.div key="new-entry" initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.98 }} className="flex-1 max-w-4xl mx-auto w-full bg-[#0F172A]/80 backdrop-blur-2xl border border-glass-border rounded-[32px] p-8 md:p-12 shadow-[0_0_50px_rgba(0,0,0,0.4)] flex flex-col overflow-y-auto no-scrollbar">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
              <div className="bg-slate-900/50 p-6 rounded-3xl border border-glass-border group hover:border-emerald-500/50 transition-all">
                ...
                <input type="number" onKeyDown={handleNumericInput} value={cashAmount || ''} onChange={e => setCashAmount(Number(e.target.value))} className="w-full bg-transparent border-b border-gray-800 text-3xl font-mono font-black text-white outline-none focus:border-emerald-400" placeholder="0.00" />
              </div>
              <div className="bg-slate-900/50 p-6 rounded-3xl border border-glass-border group hover:border-cyan-500/50 transition-all">
                ...
                <input type="number" onKeyDown={handleNumericInput} value={bankAmount || ''} onChange={e => setBankAmount(Number(e.target.value))} className="w-full bg-transparent border-b border-gray-800 text-3xl font-mono font-black text-white outline-none focus:border-cyan-400" placeholder="0.00" />
              </div>
              <div className="bg-slate-900/50 p-6 rounded-3xl border border-glass-border group hover:border-pink-500/50 transition-all">
                ...
                <input type="number" onKeyDown={handleNumericInput} value={discountAmount || ''} onChange={e => setDiscountAmount(Number(e.target.value))} className="w-full bg-transparent border-b border-gray-800 text-3xl font-mono font-black text-white outline-none focus:border-pink-400" placeholder="0.00" />
              </div>
            </div>
